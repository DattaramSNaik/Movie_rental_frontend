...
const Navbar = () => {
  return (
    <div data-aos="fade-down">
      <nav className="bg-gray-900 border-gray-200 px-2 sm:px-4 py-2.5  dark:bg-white-800">
        <div className="container flex flex-wrap justify-between items-center mx-auto logo">
          <a href="#" className="flex items-center">
            <h1 className="mr-1 h-6 sm:h-9 font-mono font-bold text-2xl text-white logo">
              Movie
            </h1>
          ...
          <div className=" w-full md:block md:w-auto" id="mobile-menu">
            <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              <li>
                <NavLink
                  className="text-base block py-2 pr-4 pl-3 text-white border-b border-gray-100 
                  hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                  to="/movies"
                  style={({ isActive }) => {
                    return {
              ...
              <li>
                <NavLink
                  className="text-base block py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-white md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                  to="/genre"
                  style={({ isActive }) => {
                    return {
                      color: isActive ? "DodgerBlue" : "",
